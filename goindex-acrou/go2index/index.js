// =======Options START=======
var authConfig = {
  siteName: "drive.esherloon.com", // 网站名称
  version: "1.1.2", // 程序版本
  theme: "acrou",
...
var themeOptions = {
  cdn: "https://cdn.jsdelivr.net/gh/jinoo2005609/goindex",
  // 主题版本号
  version: "master",
...
<html>
<head>
<meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0,maximum-scale=1.0, user-scalable=no"/> <title>${authConfig.siteName}</title> <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1"><meta name="description" content="drive.esherloon.com"><meta name="theme-color" content="#FF3300"><meta name="robots" content="index, follow"><link rel="shortcut icon" href="https://cdn.jsdelivr.net/gh/jinoo2005609/goindex@master/goindex-acrou/public/favicon.ico"><meta property="og:site_name" content="drive.esherloon.com"><meta property="og:type" content="website"><meta property="og:image" content="https://cdn.jsdelivr.net/gh/jinoo2005609/goindex@master/goindex-acrou/public/favicon.ico"><meta property="og:description" content="drive.esherloon.com"><meta property="og:title" content="drive.esherloon.com"><meta property="og:url" content="https://drive.esherloon.com"><link rel="apple-touch-icon" href="https://cdn.jsdelivr.net/gh/jinoo2005609/goindex@master/goindex-acrou/public/favicon.ico"><link rel="icon" type="image/png" sizes="32x32" href="https://cdn.jsdelivr.net/gh/jinoo2005609/goindex@master/goindex-acrou/public/favicon.ico"><meta name="google-site-verification" content=""/> <style>@import url(${themeOptions.cdn}@${themeOptions.version}/goindex-acrou/dist/style.min.css); </style> <script>window.gdconfig=JSON.parse('${JSON.stringify({version: authConfig.version, themeOptions: themeOptions,})}'); window.themeOptions=JSON.parse('${JSON.stringify(themeOptions)}'); window.gds=JSON.parse('${JSON.stringify( authConfig.roots.map((it)=> it.name) )}'); window.MODEL=JSON.parse('${JSON.stringify(model)}'); window.current_drive_order=${current_drive_order}; </script>
</head>
<body>
    <div id="app"></div>
